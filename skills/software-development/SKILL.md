...
Apply software engineering principles from `.constitution/software-engineering.md`.

## Core Principles

Follow these fundamental principles when implementing features:
...
For complete details and examples, read `.constitution/software-engineering.md`.
